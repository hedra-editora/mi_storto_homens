...
\pagebreak
\thispagestyle{empty}
\addcontentsline{toc}{chapter}{A história de Oti, o Lua}
\mbox{}
\begin{center}
\vspace{4cm}
...
{\formular\huge A história de Oti,\\\vspace{0.2cm} o Lua}
\end{center}
\pagebreak
...
\mbox{}
\vfill
\noindent{}\textit{O próximo capítulo conta a história do Lua, um homem chamado Oti. É uma importante narrativa que também compõe o \emph{corpus} mítico dos Karitiana. Quando vivia entre os humanos, Oti teve relações sexuais não consentidas com a mãe e a irmã. Esta última descobriu que o irmão a visitava à noite, no escuro, após seguir a sugestão de seu namorado de passar tinta de jenipapo no intruso durante uma dessas relações sexuais. A mãe, por sua vez, foi forçada por Lua a ceder a seus desejos quando foram para a floresta buscar os frutos da palmeira patauá.\footnote{\emph{Oenocarpus bataua}, também conhecida por \emph{patuá} ou \emph{patoá}.} Após esses eventos, Lua subiu nessa palmeira e foi viver no céu. Contudo, antes disso, cortou suas próprias pernas, para que fossem sepultadas junto com seus objetos e decidiu que todas as mulheres, a partir de então, passariam a menstruar.}\footnote{A narrativa de Oti foi contada por Garcia Karitiana para Luciana Storto, que a transcreveu e fez uma tradução preliminar. Para esta publicação, o material foi traduzido e revisado por Inácio Karitiana, Nelson Karitiana, Íris Morais Araújo, Karin Vivanco e Luciana Storto.}
\pagebreak
...
\pagebreak
\thispagestyle{empty}
\addcontentsline{toc}{chapter}{Antes de o menino caçar e se casar}
\mbox{}
\begin{center}
\vspace{4cm}
...
{\formular\huge Antes de o menino caçar\\\vspace{0.2cm} e se casar}
\end{center}
\pagebreak
...
\noindent  Na fossa, então, havia macacos\\
 ...
 Nós não íamos longe\\
 %\item \\
 Cutia é a primeira caça que aparecia sorrateiramente\\
 %\item \\
 ...
 %\item 
 Nambus, quando fazemos o Osiip, aparecem muitos nambus
...
\noindent   Eu fui, andei, andei, andei, sentei\\
 ...
 %\item\\
  \emph{Hong}, ele fez. \emph{Hong, aqui tem alguém}, disse o homem\\
 %\item\\
  \emph{Hong}, \emph{hong}, \emph{hong}, fizeram\\
 %\item\\
  Dizem que chegaram na tocaia\\
 %\item\\
  \emph{Olha aqui, olha aqui, aqui tem alguém}, disseram\\
 %\item\\
  \emph{Você matou cutia, amigo?},\footnote{Amigo ou querido(a), com a função de um vocativo.} ele falou. \emph{Amigo?} (silêncio)\\
 %\item\\
...
\noindent   Meu finado pai levou o finado pai de Nyorem.\footnote{O narrador se refere ao pai da Lourdes Karitiana (Nyorem).}\\
 %\item\\
  \emph{Onde é o rio Bisỹ Herednemo, meu avô?}\\
 %\item\\
...
\noindent   Andaram, andaram, andaram.\\
 ...
 %\item\\
  \emph{Pij̃ bok bok xak}, e atiramos no mutum\\
 %\item\\
...
\noindent   Então chegou o gavião \emph{pãram}\footnote{Espécie de gavião que
 ...
 %\item\\
  \emph{Rinh} disse a anta\\
 %\item\\
  \emph{Rinh}, enquanto ele estava lá\\
 %\item\\
